...
|-----------------|-------------|---------------|-----------|
| Анализ и проектирование | 0.5 | 15,000 ₽ | 7,500 ₽ |
| Разработка базового функционала | 1.5 | 15,000 ₽ | 22,500 ₽ |
| Тестирование и документация | 1 | 20,000 ₽ | 20,000 ₽ |
| **Итого** | **3** | | **50,000 ₽** |

## Ускорение разработки

Для завершения разработки в сжатые сроки (3 дня вместо стандартных 7-10) были применены следующие подходы:
...
Общая оценка стоимости ускоренной разработки скрипта `zabbix_disk_monitor_levels-full.sh` составляет **50,000 ₽** с выполнением за **3 рабочих дня**. 
...
Скрипт обеспечивает автоматизацию настройки мониторинга системных ресурсов в Zabbix и может использоваться для быстрого развертывания системы мониторинга. 
